...
# freecad/nestingworkbench/Tools/ManualNester/manual_nester_panel_manager.py
...
class ManualNesterTaskPanel:
    ...
    def cleanup(self):
        ...
        from freecad.nestingworkbench.commands.command_manual_nester import ManualNesterCommand
