...
class AnnealUI(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.sa_temp_initial_input = QtGui.QDoubleSpinBox(); self.sa_temp_initial_input.setRange(1, 100000); self.sa_temp_initial_input.setValue(1000)
        self.sa_temp_final_input = QtGui.QDoubleSpinBox(); self.sa_temp_final_input.setRange(0.01, 1000); self.sa_temp_final_input.setValue(1)
        self.sa_cooling_rate_input = QtGui.QDoubleSpinBox(); self.sa_cooling_rate_input.setRange(0.8, 0.999); self.sa_cooling_rate_input.setSingleStep(0.01); self.sa_cooling_rate_input.setValue(0.95)
        self.sa_substeps_input = QtGui.QSpinBox(); self.sa_substeps_input.setRange(1, 10000); self.sa_substeps_input.setValue(10)
        self.sa_total_max_iter_input = QtGui.QSpinBox(); self.sa_total_max_iter_input.setRange(100, 100000); self.sa_total_max_iter_input.setValue(1000)
        self.sa_minima_threshold_input = QtGui.QSpinBox(); self.sa_minima_threshold_input.setRange(1, 100); self.sa_minima_threshold_input.setValue(5)
